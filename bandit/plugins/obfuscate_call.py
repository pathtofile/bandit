...
def internal_call_used(context):
    ...
    its .__call__ param. This can be used to obfuscate or hide usage of
    blacklisted funcations, such as Python's `exec` method.
    ...
    .. code-block:: none
        ...
        Location: ./examples/obfuscate_call.py:1
